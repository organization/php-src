...
#define ZEND_CALL_HAS_SYMBOL_TABLE   (1 << 3)
#define ZEND_CALL_CLOSURE            (1 << 4)
#define ZEND_CALL_RELEASE_THIS       (1 << 5)
#define ZEND_CALL_FREE_EXTRA_ARGS    (1 << 6) /* equal to IS_TYPE_REFCOUNTED */
