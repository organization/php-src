...
ZEND_API int zend_prepare_string_for_scanning(zval *str, char *filename)
{
	...
	ZVAL_NEW_STR(str, zend_string_extend(Z_STR_P(str), old_len + ZEND_MMAP_AHEAD, 0));
...
#line 1289 "Zend/zend_language_scanner.c"
yy16:
	YYDEBUG(16, *YYCURSOR);
	++YYCURSOR;
	if ((yych = *YYCURSOR) == '\n') goto yy14;
...
#line 1387 "Zend/zend_language_scanner.c"
yy21:
		YYDEBUG(21, *YYCURSOR);
		yych = *++YYCURSOR;
		if (yych <= '_') {
...
#line 3048 "Zend/zend_language_scanner.c"
yy162:
...
#line 3058 "Zend/zend_language_scanner.c"
yy164:
